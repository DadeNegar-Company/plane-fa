  ...
  return (
    ...
    >
      ...
      {isDraggingOver && enableDragDrop && (
        <div className="absolute top-0 start-0 h-full w-full flex items-center justify-center text-13 font-medium text-tertiary rounded-sm bg-layer-1/85 border-[1px] border-strong z-[2]">
