                ...
                {block?.children?.map((weekDay, index) => (
                  ...
                  >
                    ...
                    <div className="space-x-1 text-11 font-medium">
                      {/* [FA-CUSTOM] Show month abbreviation when day crosses a month boundary */}
                      {weekDay.monthAbbreviation && (
                        <span className="text-placeholder text-[9px]">{weekDay.monthAbbreviation}</span>
                      )}
                      <span
                        className={cn({
