  ...
  if (isWorkspaceCreationDisabled) {
    return (
      <div className="flex flex-col gap-10">
        <span className="text-center text-14 text-tertiary">{t("onboarding.create_workspace.creation_disabled")}</span>
      </div>
    );
  }
  return (
    ...
    >
      <CommonOnboardingHeader
        title={t("onboarding.create_workspace.title")}
        description={t("onboarding.create_workspace.description")}
      />
            ...
            render={({ field: { value, ref, onChange } }) => (
              <div className="relative flex items-center rounded-md">
                <input
                  ...
                  placeholder={t("onboarding.create_workspace.placeholder")}
                  ref={ref}
                  className={cn(
      ...
      <div className="flex flex-col gap-4">
        ...
        {hasInvitations && (
          <Button variant="ghost" size="xl" className="w-full" onClick={handleCurrentViewChange}>
            {t("onboarding.create_workspace.join_existing")}
          </Button>
        )}
      </div>
    </form>
