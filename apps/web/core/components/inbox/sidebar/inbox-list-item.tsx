  ...
  return (
    <>
      ...
      >
        <Row
          className={cn(
            `flex flex-col gap-2 relative border border-t-transparent border-s-transparent border-e-transparent border-b-subtle-1 py-4 hover:bg-accent-primary/5 cursor-pointer transition-all`,
        ...
        >
          <div className="space-y-1">
            ...
            <h3 dir="auto" className="truncate w-full text-13">
              {issue.name}
            </h3>
          </div>
