...
export function ProjectHeaderButton({ project }: TProjectHeaderButtonProps) {
  return (
    <Tooltip tooltipContent={project.name} position="bottom">
      <div className="relative flex items-center text-start select-none w-full max-w-48 pe-1">
        ...
        <div className="relative flex-1 min-w-0 hover:rounded">
          ...
          <div className="absolute end-0 top-0 bottom-0 flex items-center justify-end pointer-events-none opacity-0 group-hover:opacity-100 transition-opacity duration-200">
