...
export const StickyActionBar = observer(function StickyActionBar() {
  ...
  return (
    ...
    >
      ...
      >
        <Tooltip tooltipContent={t("stickies_extra.all_stickies")} isMobile={false} position="left">
          <button
        ...
        <Tooltip tooltipContent={t("stickies_extra.add_sticky")} isMobile={false} position="left">
          <button
            className="btn btn--icon rounded-full w-10 h-10 flex items-center justify-center shadow-sm bg-surface-1"
            onClick={() => {
