...
export const ListGroup = observer(function ListGroup(props: Props) {
  ...
  const loadMore = isPaginating ? (
    ...
    <div
      className={
        "h-11 relative flex items-center gap-3 bg-surface-1 border border-transparent border-t-subtle-1 ps-8 p-3 text-13 font-medium text-accent-primary hover:text-accent-secondary hover:underline cursor-pointer"
      }
  ...
  return validateEmptyIssueGroups(groupIssueCount) ? (
    ...
    >
      <Row
        className={cn("w-full flex-shrink-0 border-b border-subtle bg-layer-1 hover:bg-layer-1-hover pe-3 py-1", {
