    ...
    <>
      ...
      >
        ...
        >
          ...
          <div
            className={`flex-shrink-0 text-13 font-medium text-tertiary ${verticalAlignPosition ? `pe-0.5` : `ps-2`}`}
          >
            {count || 0}
          </div>
        </div>
        ...
        {!disableIssueCreation &&
          (renderExistingIssueModal ? (
            ...
            >
              ...
              >
                <span className="flex items-center justify-start gap-2">{t("common.add_existing_work_item")}</span>
              </CustomMenu.MenuItem>
            </CustomMenu>
          ) : (
            <button
