...
export default {
  ...
  pages: {
    ...
    search_placeholder: "جستجوی صفحات",
    untitled: "بدون عنوان",
    toast: {
      link_copied: "لینک صفحه در کلیپ‌بورد کپی شد.",
      deleted: "صفحه حذف شد",
      duplicate: {
        success: "صفحه با موفقیت تکثیر شد.",
        error: "تکثیر صفحه ناموفق بود. لطفاً بعداً تلاش کنید.",
      },
      access: {
        made_public: "صفحه عمومی شد.",
        made_private: "صفحه خصوصی شد.",
        make_public_error: "عمومی کردن صفحه ناموفق بود. لطفاً بعداً تلاش کنید.",
        make_private_error: "خصوصی کردن صفحه ناموفق بود. لطفاً بعداً تلاش کنید.",
      },
      restore: {
        success: "صفحه با موفقیت بازیابی شد.",
        error: "بازیابی صفحه ناموفق بود. لطفاً بعداً تلاش کنید.",
      },
      archive: {
        success: "صفحه با موفقیت بایگانی شد.",
        error: "بایگانی صفحه ناموفق بود. لطفاً بعداً تلاش کنید.",
      },
      favorite: {
        success: "صفحه به علاقه‌مندی‌ها افزوده شد.",
        error: "افزودن صفحه به علاقه‌مندی‌ها ناموفق بود. لطفاً بعداً تلاش کنید.",
      },
      unfavorite: {
        success: "صفحه از علاقه‌مندی‌ها حذف شد.",
        error: "حذف صفحه از علاقه‌مندی‌ها ناموفق بود. لطفاً بعداً تلاش کنید.",
      },
      lock: {
        success: "صفحه قفل شد.",
        error: "قفل کردن صفحه ناموفق بود. لطفاً بعداً تلاش کنید.",
      },
      unlock: {
        success: "صفحه باز شد.",
        error: "باز کردن قفل صفحه ناموفق بود. لطفاً بعداً تلاش کنید.",
      },
    },
  },
  home: {
  ...
  common: {
    ...
    text_direction_title: "جهت متن",
    text_direction_description: "تعیین می‌کند رابط کاربری از راست به چپ نمایش داده شود یا از چپ به راست.",
    text_direction_ltr: "چپ‌چین",
    text_direction_rtl: "راست‌چین",
    text_direction_updated: "جهت متن با موفقیت به‌روزرسانی شد",
    text_direction_update_failed: "به‌روزرسانی جهت متن ناموفق بود",
  ...
  onboarding: {
    ...
    profile: {
      ...
      role_question: "نقش شما چیست؟",
      domain_question: "در کدام حوزه فعالیت می‌کنید؟",
      details_failed: "به‌روزرسانی اطلاعات کاربر ناموفق بود. لطفاً دوباره تلاش کنید!",
    },
    role: {
      title: "نقش شما چیست؟",
      description: "بیایید Plane را برای شیوه کار شما تنظیم کنیم.",
      select_one: "یکی را انتخاب کنید",
      product_manager: "مدیر محصول",
      engineering_manager: "مدیر مهندسی",
      designer: "طراح",
      developer: "توسعه‌دهنده",
      founder: "بنیان‌گذار/مدیر اجرایی",
      operations_manager: "مدیر عملیات",
      others: "سایر",
    },
    invitations: {
      title: "شما دعوت شده‌اید!",
      subtitle: "برای همکاری با تیم خود، دعوت‌ها را بپذیرید.",
    },
    finish_failed: "تکمیل آماده‌سازی ناموفق بود. لطفاً بعداً تلاش کنید.",
    team: {
  ...
  toasts: {
    attachment: {
      uploaded_title: "پیوست بارگذاری شد",
      uploaded_message: "پیوست با موفقیت بارگذاری شد",
      not_uploaded_title: "پیوست بارگذاری نشد",
      not_uploaded_message: "پیوست بارگذاری نشد",
      uploading: "در حال بارگذاری پیوست...",
      removed_title: "پیوست حذف شد",
      removed_message: "پیوست با موفقیت حذف شد",
      not_removed_title: "پیوست حذف نشد",
      not_removed_message: "پیوست حذف نشد",
      file_attach_error: "فایل پیوست نشد. لطفاً دوباره تلاش کنید.",
    },
    reaction: {
      created: "واکنش با موفقیت ثبت شد",
      created_failed: "ثبت واکنش انجام نشد",
      removed: "واکنش با موفقیت حذف شد",
      removed_failed: "حذف واکنش انجام نشد",
    },
    link: {
      created: "پیوند با موفقیت ایجاد شد",
      created_failed: "ایجاد پیوند انجام نشد",
      updated: "پیوند با موفقیت به‌روز شد",
      updated_failed: "به‌روزرسانی پیوند انجام نشد",
      deleted: "پیوند با موفقیت حذف شد",
      deleted_failed: "حذف پیوند انجام نشد",
      copied: "پیوند در کلیپ‌بورد کپی شد",
    },
    work_item: {
      select_at_least_one: "لطفاً حداقل یک کار را انتخاب کنید.",
      link_copied: "پیوند کار در کلیپ‌بورد کپی شد",
      restored_message: "کار شما در کارهای پروژه قابل مشاهده است.",
      restore_failed: "بازیابی کار انجام نشد. لطفاً دوباره تلاش کنید.",
      added_to_cycle: "کارها با موفقیت به چرخه اضافه شدند.",
      added_to_cycle_failed: "افزودن کارهای انتخابی به چرخه انجام نشد. لطفاً دوباره تلاش کنید.",
      cannot_move: "امکان جابجایی کار وجود ندارد",
      due_before_start: "تاریخ سررسید نمی‌تواند قبل از تاریخ شروع کار باشد.",
      view_empty_title: "کارهای نما اینجا نمایش داده می‌شوند",
      delete_success: "کار با موفقیت حذف شد",
      delete_failed: "حذف کار انجام نشد",
      update_failed: "به‌روزرسانی کار انجام نشد",
      permission_denied: "دسترسی مجاز نیست",
    },
  },
  workspace_projects_toasts: {
    delete: {
      success_title: "پروژه حذف شد",
      success_message: "پروژه با موفقیت حذف شد.",
      error_title: "پروژه حذف نشد",
      error_message: "حذف پروژه انجام نشد. لطفاً دوباره تلاش کنید.",
      placeholder: "«delete my project» را وارد کنید",
      confirm_text: "delete my project",
    },
    leave: {
      success_title: "از پروژه خارج شدید",
      success_message: "با موفقیت از پروژه خارج شدید.",
      error_title: "خروج از پروژه انجام نشد",
      error_message: "خروج از پروژه انجام نشد. لطفاً دوباره تلاش کنید.",
      placeholder: "«leave my project» را وارد کنید",
      confirm_text: "leave my project",
      confirm_required: "لطفاً با تایپ 'Leave Project' خروج از پروژه را تأیید کنید.",
      name_mismatch: "لطفاً نام پروژه را همان‌طور که در توضیحات نشان داده شده وارد کنید.",
      fields_required: "لطفاً همه فیلدها را پر کنید.",
      confirm_placeholder: "عبارت 'leave project' را وارد کنید",
    },
    archive: {
      success_title: "بایگانی موفق",
      success_message: "پروژه با موفقیت بایگانی شد.",
      error_title: "بایگانی انجام نشد",
      error_message: "بایگانی پروژه انجام نشد. لطفاً دوباره تلاش کنید.",
      restore_success_title: "بازیابی موفق",
      restore_success_message: "پروژه با موفقیت بازیابی شد.",
      restore_error_title: "بازیابی انجام نشد",
      restore_error_message: "بازیابی پروژه انجام نشد. لطفاً دوباره تلاش کنید.",
    },
    card: {
      link_copied_title: "پیوند کپی شد!",
      link_copied_message: "پیوند پروژه در کلیپ‌بورد کپی شد.",
    },
    permission: {
      cant_change_role: "هنوز نمی‌توانید این نقش را تغییر دهید.",
      member_denied_title: "دسترسی مجاز نیست",
      member_denied_message: "اجازه انجام این عمل را ندارید.",
      cannot_leave_yet: "هنوز نمی‌توانید از این پروژه خارج شوید.",
      cannot_remove_member_yet: "هنوز نمی‌توانید این عضو را از پروژه حذف کنید.",
    },
    integration: {
      sync_error: "همگام‌سازی پروژه انجام نشد. لطفاً دوباره تلاش کنید.",
    },
    publish: {
      enabled_title: "پروژه منتشر شد",
      enabled_message: "پروژه با موفقیت منتشر شد.",
      updated_title: "تنظیمات به‌روز شد",
      updated_message: "تنظیمات انتشار با موفقیت به‌روزرسانی شد!",
      disabled_title: "انتشار لغو شد",
      disabled_message: "انتشار پروژه با موفقیت لغو شد.",
      error_title: "مشکلی پیش آمد",
      error_message: "هنگام لغو انتشار پروژه خطایی رخ داد.",
      select_view_layout: "لطفاً حداقل یک طرح‌بندی نما را برای انتشار پروژه انتخاب کنید.",
      link_copied: "لینک صفحه منتشرشده با موفقیت کپی شد.",
    },
    members: {
      added_success: "اعضا با موفقیت اضافه شدند.",
    },
    form: {
      identifier_required: "شناسه پروژه الزامی است.",
      name_max: "نام پروژه باید کمتر از ۲۵۵ کاراکتر باشد",
    },
  },
  workspace_settings_toasts: {
    update_success: "فضای کاری با موفقیت به‌روز شد.",
  ...
  exporter_extra: {
    ...
    services: "سرویس‌ها",
    exported_by: "صادر شده توسط",
    exported_on: "صادر شده در",
    exported_projects: "پروژه‌های صادر شده",
    format: "فرمت",
    status: "وضعیت",
    expired: "منقضی شده",
    no_previous_exports: "خروجی قبلی وجود ندارد",
    download: "دانلود",
    all_projects: "همه پروژه‌ها",
  },
  automations_extra: {
    customize_time_in_days: "زمان را به روز شخصی‌سازی کنید",
    select_days: "روزها را انتخاب کنید",
    days: "روز",
    invalid_input: "لطفاً تعداد معتبری از روزها را وارد کنید.",
    enter_days: "تعداد روزها",
  },
  views_quick_action: {
  ...
  workspace_wrapper_toasts: {
    error_title: "مشکلی پیش آمد",
    error_message: "لطفاً صفحه را تازه کنید یا با پشتیبانی تماس بگیرید.",
  },
  power_k_categories: {
    cycles: "چرخه‌ها",
    work_items: "کارها",
    ...
    projects: "پروژه‌ها",
    workspaces: "فضاهای کاری",
    search_shortcuts: "جستجوی میان‌برها",
    theme_updated: "پوسته به‌روز شد",
    some_error: "خطایی رخ داد",
  },
  notifications_snooze: {
    customize_title: "زمان یادآوری مجدد را شخصی‌سازی کنید",
    pick_date: "تاریخی را انتخاب کنید",
    pick_time: "زمانی را انتخاب کنید",
    select_date: "انتخاب تاریخ",
    select_time: "انتخاب زمان",
    no_time: "زمانی برای این تاریخ در دسترس نیست.",
  },
  pages_lock: {
    lock: "قفل",
    locked: "قفل شد",
  ...
  ai_menu_extra: {
    add_to_next_line: "افزودن به خط بعد",
  ...
  rich_filters_extra: {
    invalid_filter: "فیلتر نامعتبر",
    invalid_filter_tooltip: "این فیلتر نامعتبر یا دیگر قابل استفاده نیست. لطفاً آن را حذف کنید.",
    remove_filter: "حذف فیلتر",
    config_error_title: "خطای پیکربندی فیلتر",
    config_error_message: "این فیلتر به درستی پیکربندی نشده است. لطفاً با پشتیبانی تماس بگیرید.",
    toggle_workspace_search: "تغییر وضعیت جستجوی سطح فضای کاری",
  },
  inbox_toast: {
    work_item_deleted: "کار با موفقیت حذف شد",
