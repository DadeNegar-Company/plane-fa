...
export default {
  ...
  workspace_projects_toasts: {
    ...
    publish: {
      ...
      updated_message: "تنظیمات انتشار پروژه به‌روز شد.",
      disabled_title: "انتشار لغو شد",
      disabled_message: "انتشار پروژه با موفقیت لغو شد.",
      error_title: "مشکلی پیش آمد",
      error_message: "به‌روزرسانی تنظیمات انتشار انجام نشد. لطفاً دوباره تلاش کنید.",
    },
    members: {
  ...
  exporter_extra: {
    ...
    services: "سرویس‌ها",
    exported_by: "خروجی گرفته شده توسط",
    status: "وضعیت",
    expired: "منقضی",
