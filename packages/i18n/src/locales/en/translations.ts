...
export default {
  ...
  pages: {
    ...
    toast: {
      ...
      duplicate: {
        ...
        error: "Page could not be duplicated. Please try again later.",
      },
      access: {
        made_public: "Page made public.",
        made_private: "Page made private.",
        make_public_error: "Page could not be made public. Please try again later.",
        make_private_error: "Page could not be made private. Please try again later.",
      },
      restore: {
        success: "Page restored successfully.",
        error: "Page could not be restored. Please try again later.",
      },
      archive: {
        success: "Page archived successfully.",
        error: "Page could not be archived. Please try again later.",
      },
      favorite: {
        success: "Page added to favorites.",
        error: "Page could not be added to favorites. Please try again later.",
      },
      unfavorite: {
        success: "Page removed from favorites.",
        error: "Page could not be removed from favorites. Please try again later.",
      },
      lock: {
        success: "Page locked.",
        error: "Page could not be locked. Please try again later.",
      },
      unlock: {
        success: "Page unlocked.",
        error: "Page could not be unlocked. Please try again later.",
      },
    },
  },
  home: {
  ...
  common: {
    ...
    minutes: "Minutes",
    date_worked: "Date",
    logged_time: "logged {time} on {date}",
    clear_all: "Clear all",
    copied: "Copied!",
    link_copied: "Link copied!",
    ...
    work_item_does_not_exist_title: "Work item does not exist",
    work_item_does_not_exist_description:
      "The work item you are looking for does not exist, has been archived, or has been deleted.",
    view_does_not_exist_title: "View does not exist",
    view_does_not_exist_description: "The view you are looking for does not exist or has been deleted.",
    ...
    drop_here: "Drop here...",
    uploading: "Uploading...",
    invalid_file_type_or_size: "Invalid file type or size (max {size} MB)",
    select_work_item: "Select work item",
    add_assignees: "Add assignees",
    add_due_date: "Add due date",
    duplicate_of: "Duplicate of",
    no_request_closed_title: "No request closed yet",
    no_request_closed_description: "All the work items whether accepted or declined can be found here.",
    ...
    dismiss_content_limit_warning: "Dismiss content limit warning",
    ...
    offline_changes_will_sync: "You can continue making changes. They will be synced when you are back online.",
    offline: "Offline",
    icon_only: "Icon only",
    ...
    text_direction_title: "Text direction",
    text_direction_description: "Choose whether the interface is rendered right-to-left or left-to-right.",
    text_direction_ltr: "Left-to-right",
    text_direction_rtl: "Right-to-left",
    text_direction_updated: "Text direction updated successfully",
    text_direction_update_failed: "Failed to update text direction",
    ...
    tell_ai_what_to_do: "Tell AI what to do...",
    publish_project: "Publish project",
  ...
  project_cycles: {
    ...
    action: {
      ...
      create: {
        ...
        failed: {
          description: "Error in creating cycle. Please try again.",
        },
        error: {
          already_exists:
      ...
      delete: {
        title: "Delete cycle",
        content_prefix: "Are you sure you want to delete cycle ",
        content_suffix:
        ...
        failed: {
          description: "Error deleting cycle. Please try again.",
        },
      },
      archive: {
        title: "Archive cycle {name}",
        confirm_message: "Are you sure you want to archive the cycle? All your archives can be restored later.",
        success: {
          title: "Archive success",
          description: "Your archives can be found in project archives.",
        },
        failed: {
          description: "Cycle could not be archived. Please try again.",
        },
      },
    },
    transfer: {
      ...
      no_cycle_to_transfer: "You don’t have any current cycle. Please create one to transfer the work items.",
      loading: "Loading...",
      ...
      fetch_error_message: "Unable to fetch cycle details",
    },
    empty_state: {
      general: {
  ...
  project_modules: {
    ...
    display_property: {
      ...
      target_date: "Due date",
      progress: "Progress",
      issue_count: "Work items",
    },
    zero_issues: "0 work items",
    archived: {
      no_matches: "No matching modules",
      remove_filters: "Remove the filters to see all modules",
      remove_search: "Remove the search criteria to see all modules",
    },
    delete: {
      title: "Delete module",
      description_prefix: "Are you sure you want to delete module-",
      description_suffix:
        "? All of the data related to the module will be permanently removed. This action cannot be undone.",
    },
    toasts: {
      delete: {
        success: { title: "Success!", message: "Module deleted successfully." },
      },
      link_created: { message: "Module link created successfully." },
      link_updated: { message: "Module link updated successfully." },
      update: {
        success: { title: "Success!", message: "Module updated successfully." },
        error: { title: "Error!", message: "Module could not be updated. Please try again." },
      },
      create: {
        success: { title: "Success!", message: "Module created successfully." },
        error: { title: "Error!", message: "Error in creating module. Please try again." },
      },
      favorite: {
        loading: "Adding module to favorites...",
        success: { title: "Success!", message: "Module added to favorites." },
        error: { title: "Error!", message: "Couldn't add module to favorites. Please try again." },
      },
      unfavorite: {
        loading: "Removing module from favorites...",
        success: { title: "Success!", message: "Module removed from favorites." },
        error: { title: "Error!", message: "Couldn't remove module from favorites. Please try again." },
      },
      link_deleted: { message: "Module link deleted successfully." },
      copy_link: { title: "Link Copied!", message: "Module link copied to clipboard." },
      restore: {
        success: { title: "Restore success", message: "Your module can be found in project modules." },
        error: { title: "Error!", message: "Module could not be restored. Please try again." },
      },
    },
  },
  cycle: {
  ...
  onboarding: {
    ...
    use_case: {
      ...
      profile_failed: "Profile setup failed. Please try again!",
    },
    profile: {
      ...
      name_max: "Name must be within 50 characters.",
      ...
      role_question: "What's your role?",
      domain_question: "Which domain do you work in?",
      details_failed: "User details update failed. Please try again!",
    },
    role: {
    ...
    invitations: {
      ...
      subtitle: "Accept the invites to collaborate with your team.",
    },
    finish_failed: "Failed to finish onboarding, Please try again later.",
    team: {
      ...
      not_email: "That doesn't look like an email address.",
  ...
  webhooks_extra: {
    delete_modal: {
      ...
      error: "Webhook could not be deleted. Please try again.",
    },
    empty_state: {
      title: "No webhooks",
      description: "Create webhooks to receive real-time updates and automate actions",
  ...
  api_tokens_extra: {
    select_expiration: "Please select an expiration date.",
    custom: "Custom",
  ...
  labels_extra: {
    ...
    delete_confirm:
      "Are you sure you want to delete <highlight>{name}</highlight>? This will remove the label from all the work item and from any views where the label is being filtered upon.",
    delete_error: "Label could not be deleted. Please try again.",
  },
  states_extra: {
    delete_title: "Delete State",
    delete_confirm:
      "Are you sure you want to delete state- <highlight>{name}</highlight>? All of the data related to the state will be permanently removed. This action cannot be undone.",
    delete_has_items:
      "This state contains some work items within it, please move them to some other state to delete this state.",
    delete_error: "State could not be deleted. Please try again.",
    cannot_delete_default: "Cannot delete the default state.",
    cannot_empty_group: "Cannot have an empty group.",
  ...
  resizable_sidebar: {
    ...
    sidebar_peek_view: "Sidebar peek view",
  },
  power_k_extra: {
    clear_context: "Clear context (Backspace)",
  },
  integrations_extra: {
    deleted_successfully: "Deleted successfully!",
    delete_success_message: "{title} integration deleted successfully.",
    delete_error_message: "{title} integration could not be deleted. Please try again.",
  ...
  notifications_extra: {
    customize_snooze: "Customize Snooze Time",
  ...
  image_picker: {
    ...
    image_not_uploaded_message: "The image could not be uploaded",
    search_for_images: "Search for images",
    no_images_found: "No images found.",
    drop_to_upload: "Drop image here to upload",
    drag_and_drop: "Drag & drop image here",
    file_too_large: "The image size cannot exceed 5 MB.",
    invalid_file: "Please upload a file in a valid format.",
    formats_supported: "File formats supported- .jpeg, .jpg, .png, .webp",
    edit: "Edit",
    uploading: "Uploading",
  ...
  filters_extra: {
    ...
    invalid_filter: "This filter is invalid or no longer applicable. Please remove it.",
  },
  app_pages: {
    projects: "Projects",
  ...
  member_defaults: {
    project_lead: "Project Lead",
    project_lead_description: "Set a default lead for the project.",
    default_assignee: "Default Assignee",
    default_assignee_description: "Set a default assignee for new work items.",
    guest_access: "Guest access",
    guest_access_description: "Allow guests to view this project.",
  },
  estimates_root: {
    estimates_list: "Estimates list",
    archived_estimates: "Archived estimates",
  },
  cycles_extra: {
    no_matching_cycles: "No matching cycles",
  },
  ...
  toasts: {
    attachment: {
      uploaded_title: "Attachment uploaded",
      uploaded_message: "The attachment has been successfully uploaded",
      not_uploaded_title: "Attachment not uploaded",
      not_uploaded_message: "The attachment could not be uploaded",
      uploading: "Uploading attachment...",
      removed_title: "Attachment removed",
      removed_message: "The attachment has been successfully removed",
      not_removed_title: "Attachment not removed",
      not_removed_message: "The attachment could not be removed",
      file_attach_error: "File could not be attached. Try uploading again.",
    },
    reaction: {
      created: "Reaction created successfully",
      created_failed: "Reaction creation failed",
      removed: "Reaction removed successfully",
      removed_failed: "Reaction remove failed",
    },
    link: {
      created: "Link created successfully",
      created_failed: "Link creation failed",
      updated: "Link updated successfully",
      updated_failed: "Link update failed",
      deleted: "Link deleted successfully",
      deleted_failed: "Link deletion failed",
      copied: "Link copied to clipboard",
    },
    work_item: {
      select_at_least_one: "Please select at least one work item.",
      link_copied: "Work item link copied to clipboard",
      restored_message: "Your work item can be found in project work items.",
      restore_failed: "Work item could not be restored. Please try again.",
      added_to_cycle: "Work items added to the cycle successfully.",
      added_to_cycle_failed: "Selected work items could not be added to the cycle. Please try again.",
      cannot_move: "Cannot move work item",
      due_before_start: "Due date cannot be before the start date of the work item.",
      view_empty_title: "View work items will appear here",
      delete_success: "Work item deleted successfully",
  ...
  workspace_projects_toasts: {
    delete: {
      success_title: "Project deleted",
      success_message: "Project deleted successfully.",
      error_title: "Project not deleted",
      error_message: "Project could not be deleted. Please try again.",
      placeholder: "Enter 'delete my project'",
      confirm_text: "delete my project",
    },
    leave: {
      success_title: "Left project",
      success_message: "You have successfully left the project.",
      error_title: "Couldn't leave project",
      error_message: "Project could not be left. Please try again.",
      placeholder: "Enter 'leave my project'",
      confirm_text: "leave my project",
      confirm_required: "Please confirm leaving the project by typing the 'Leave Project'.",
      name_mismatch: "Please enter the project name as shown in the description.",
      fields_required: "Please fill all fields.",
      confirm_placeholder: "Enter 'leave project'",
    },
    archive: {
      success_title: "Archive success",
      success_message: "Project archived successfully.",
      error_title: "Archive failed",
      error_message: "Project could not be archived. Please try again.",
      restore_success_title: "Restore success",
      restore_success_message: "Project restored successfully.",
    ...
    card: {
      ...
      link_copied_message: "Project link copied to clipboard.",
    },
    permission: {
      cant_change_role: "You can't change this role yet.",
      member_denied_title: "Permission denied",
      member_denied_message: "You don't have permission to perform this action.",
      cannot_leave_yet: "You can't leave this project yet.",
      cannot_remove_member_yet: "You can't remove the member from this project yet.",
    },
    integration: {
      sync_error: "Could not sync project. Please try again.",
    },
    publish: {
      enabled_title: "Project published",
      enabled_message: "Project has been published successfully.",
      updated_title: "Settings updated",
      updated_message: "Publish settings updated successfully!",
      disabled_title: "Project unpublished",
      disabled_message: "Project has been unpublished successfully.",
      error_title: "Something went wrong",
      error_message: "Something went wrong while unpublishing the project.",
      select_view_layout: "Please select at least one view layout to publish the project.",
      link_copied: "Published page link copied successfully.",
    },
    members: {
      added_success: "Members added successfully.",
    },
    form: {
      identifier_required: "Project identifier is required.",
      name_max: "Project name should be less than 255 characters",
    },
  },
  workspace_settings_toasts: {
    update_success: "Workspace updated successfully.",
    update_error: "Workspace could not be updated. Please try again.",
    logo_updated: "Logo updated successfully.",
    logo_removed: "Logo removed successfully.",
    updated: "Workspace updated successfully",
    picture_removed: "Workspace picture removed successfully.",
    picture_remove_failed: "There was some error in deleting your profile picture. Please try again.",
    url_copied: "Workspace URL copied to the clipboard.",
  },
  exporter_extra: {
    csv: "CSV",
    excel: "Excel",
    ...
    exported_projects: "Exported projects",
    format: "Format",
    status: "Status",
    expired: "Expired",
    no_previous_exports: "No previous exports",
    download: "Download",
    all_projects: "All projects",
  },
  automations_extra: {
    customize_time_in_days: "Customize time in days",
    select_days: "Select days",
    days: "Days",
    invalid_input: "Please enter a valid number of days.",
  ...
  workspace_wrapper_toasts: {
    error_title: "Something went wrong",
    error_message: "Please try refreshing the page or contact support.",
  },
  power_k_categories: {
    cycles: "Cycles",
    work_items: "Work items",
  ...
  notifications_snooze: {
    customize_title: "Customize Snooze Time",
    pick_date: "Pick a date",
    pick_time: "Pick a time",
    select_date: "Select date",
    select_time: "Select a time",
    no_time: "No available time for this date.",
  },
  pages_lock: {
    lock: "Lock",
    locked: "Locked",
  ...
  ai_menu_extra: {
    add_to_next_line: "Add to next line",
    regenerate: "Re-generate response",
  },
  sidebar_extra: {
    pin: "Pin",
    unpin: "Unpin",
  ...
  rich_filters_extra: {
    ...
    invalid_filter_tooltip: "This filter is invalid or no longer applicable. Please remove it.",
    remove_filter: "Remove filter",
    config_error_title: "Filter configuration error",
    config_error_message: "This filter is not properly configured. Please contact support.",
    toggle_workspace_search: "Toggle workspace level search",
  },
  inbox_toast: {
